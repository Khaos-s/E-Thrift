...
<body class="homepage" data-bs-theme="dark">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <defs>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="  " viewBox="0 0 24 24">
        <path fill="currentColor"
      ...
      <div class="row justify-content-between align-items-center w-100">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="pages/shop-sidebar.php" class="dropdown-item item-anchor">Shop Sidebar </a>
                    </li>
                    <li>
        ...
        <div class="col-4 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            ...
            &nbsp;&nbsp;
            <a href="check-out.php" class="cart-button">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M3 3h2l3 9h10l3-9h2" stroke="currentColor" stroke-width="2"></path>
        <circle cx="9" cy="20" r="2" stroke="currentColor" stroke-width="2"></circle>
        <circle cx="17" cy="20" r="2" stroke="currentColor" stroke-width="2"></circle>
    </svg>
</a>
            ...
            <li class="d-none d-lg-block">
              <a href="" class="text-uppercase mx-3" data-bs-toggle="modal" data-bs-target="#reg">
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="21" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
  ...
  <div class="modal fade" id="reg" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="process/process.php" method="POST">                        <!-- Backend route for registration -->
